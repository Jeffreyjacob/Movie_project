...
const SearchMoviecard = ({ ImgId, Title,movieid,genre,rating,similarMovie,tvSeries,mediaType}) => {
            ...
            <div className='relative group'>
                ...
                <div className="absolute inset-0 flex items-center justify-center 
                 opacity-0 group-hover:opacity-100">
                    <Link to={mediaType === "movie" ? `/movieDetails/${movieid}`:`/tvshowdetails/${movieid}/${Title}`}>
